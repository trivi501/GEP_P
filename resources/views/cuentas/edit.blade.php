                    ...
                    <form method="POST" action="{{ route('cuentas.update', $cuenta) }}">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div class="mb-4">
                                ...
                                <input type="text" name="indetec" id="indetec" value="{{ old('indetec', $cuenta->indetec) }}" class="w-full rounded border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-300">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="nom_indetect" id="nom_indetect" value="{{ old('nom_indetect', $cuenta->nom_indetect) }}" class="w-full rounded border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-300">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="cuenta" id="cuenta" value="{{ old('cuenta', $cuenta->cuenta) }}" class="w-full rounded border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-300">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="subcuenta" id="subcuenta" value="{{ old('subcuenta', $cuenta->subcuenta) }}" class="w-full rounded border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-300">
                            ...
                            <div class="mb-4 md:col-span-2">
                                ...
                                <textarea name="descripcion" id="descripcion" rows="3" class="w-full rounded border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-300">{{ old('descripcion', $cuenta->descripcion) }}</textarea>
                                @error('descripcion') <p class="text-red-500 text-xs mt-1">{{ $message }}</p> @enderror
                            </div>

                            <div class="mb-4">
                                <label for="importe" class="block text-sm font-medium">Importe</label>
                                <input type="number" step="0.01" min="0" name="importe" id="importe" value="{{ old('importe', $cuenta->importe) }}" class="w-full rounded border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-300">
                            ...
                            <div class="mb-4">
                                ...
                                <select name="cuentaMayor_id" id="cuentaMayor_id" class="w-full rounded border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-300">
                                    ...
                                    @foreach ($cuentasMayor as $item)
                                        <option value="{{ $item->id }}" {{ old('cuentaMayor_id', $cuenta->cuentaMayor_id) == $item->id ? 'selected' : '' }}>{{ $item->cuenta }} - {{ $item->nom_indetect }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="mb-4">
                                ...
                                <input type="number" name="indetecMayor_id" id="indetecMayor_id" value="{{ old('indetecMayor_id', $cuenta->indetecMayor_id) }}" class="w-full rounded border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-300">
                            ...
                            <div class="mb-4">
                                ...
                                <select name="conac_id" id="conac_id" class="w-full rounded border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-300">
                                    ...
                                    @foreach ($conacs as $item)
                                        <option value="{{ $item->id }}" {{ old('conac_id', $cuenta->conac_id) == $item->id ? 'selected' : '' }}>{{ $item->nombre }}</option>
                                    @endforeach
                                </select>
