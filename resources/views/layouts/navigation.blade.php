<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-dropdown align="center" width="48">
                        ...
                        <x-slot name="content">
                            ...
                            <x-dropdown-link :href="route('caja.create')">
                                {{ __('Nuevo Cobro') }}
                            </x-dropdown-link>
                        </x-slot>
                    </x-dropdown>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <div class="pt-2 pb-1">
                <div class="px-4 text-xs uppercase tracking-wider text-gray-400 dark:text-gray-500 font-semibold">Caja</div>
                <x-responsive-nav-link :href="route('caja.index')" :active="request()->routeIs('caja.index')">
                    {{ __('Historial') }}
                </x-responsive-nav-link>
