                    ...
                    <form action="{{ route('contribuyentes.store') }}" method="POST">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <x-text-input id="nombre_completo" class="block mt-1 w-full" type="text" name="nombre_completo" :value="old('nombre_completo')" />
                                <x-input-error :messages="$errors->get('nombre_completo')" class="mt-2" />
                            </div>

                            <div>
                                <x-input-label for="cuenta" :value="__('Cuenta')" />
                                <x-text-input id="cuenta" class="block mt-1 w-full" type="text" name="cuenta" :value="old('cuenta')" required />
                            ...
                            <div>
                                ...
                                <x-text-input id="nombre_moral" class="block mt-1 w-full" type="text" name="nombre_moral" :value="old('nombre_moral')" />
                                <x-input-error :messages="$errors->get('nombre_moral')" class="mt-2" />
                            </div>

                            <div>
                                <x-input-label for="primer_apellido" :value="__('Primer Apellido')" />
                                <x-text-input id="primer_apellido" class="block mt-1 w-full" type="text" name="primer_apellido" :value="old('primer_apellido')" />
                            ...
                            <div>
                                ...
                                <x-text-input id="curp_contribuyente" class="block mt-1 w-full" type="text" name="curp_contribuyente" :value="old('curp_contribuyente')" />
                            ...
                            <div>
                                ...
                                <select id="id_tipo_contribuyente" name="id_tipo_contribuyente" class="block mt-1 w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:focus:ring-indigo-600 dark:focus:ring-offset-gray-800">
                                    ...
                                    @foreach ($tiposContribuyente as $tipo)
                                        <option value="{{ $tipo->id_tipo_contribuyente }}" {{ old('id_tipo_contribuyente') == $tipo->id_tipo_contribuyente ? 'selected' : '' }}>
                            ...
                            <div>
                                ...
                                <x-text-input id="nivel_gobierno" class="block mt-1 w-full" type="text" name="nivel_gobierno" :value="old('nivel_gobierno')" />
                            ...
                            <div>
                                ...
                                <x-text-input id="correo_electronico" class="block mt-1 w-full" type="email" name="correo_electronico" :value="old('correo_electronico')" />
                        ...
                        <div class="mt-6 grid grid-cols-1 md:grid-cols-3 gap-4">
                            <label class="flex items-center space-x-2 p-3 rounded border border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700 cursor-pointer">
                                <input type="checkbox" name="exento" value="1" class="rounded border-gray-300 dark:border-gray-600 text-indigo-600 shadow-sm focus:ring-indigo-500 dark:focus:ring-indigo-600 dark:focus:ring-offset-gray-800" {{ old('exento') ? 'checked' : '' }}>
                        ...
                        <div class="mt-8 border-t border-gray-200 dark:border-gray-700 pt-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                ...
                                <div>
                                    ...
                                    <select id="id_municipio" name="id_municipio" class="block mt-1 w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:focus:ring-indigo-600 dark:focus:ring-offset-gray-800">
                                        ...
                                        @foreach ($municipios as $municipio)
                                            <option value="{{ $municipio->id_municipio }}" data-estado="{{ $municipio->id_estado }}" {{ old('id_municipio') == $municipio->id_municipio ? 'selected' : '' }}>{{ $municipio->nombre_municipio }}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div>
                                    ...
                                    <select id="colonia" name="colonia" class="block mt-1 w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:focus:ring-indigo-600 dark:focus:ring-offset-gray-800">
                                        ...
                                        @foreach ($colonias as $colonia)
                                            <option value="{{ $colonia->COLONIA }}" {{ old('colonia') == $colonia->COLONIA ? 'selected' : '' }}>{{ $colonia->COLONIA }}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <x-text-input id="nombre_vialidad" class="block mt-1 w-full" type="text" name="nombre_vialidad" :value="old('nombre_vialidad')" />
                                    <x-input-error :messages="$errors->get('nombre_vialidad')" class="mt-2" />
                                </div>

                                <div>
                                    <x-input-label for="num_exterior" :value="__('Núm. Exterior')" />
                                    <x-text-input id="num_exterior" class="block mt-1 w-full" type="text" name="num_exterior" :value="old('num_exterior')" />
                                    <x-input-error :messages="$errors->get('num_exterior')" class="mt-2" />
                                </div>

                                <div>
                                    <x-input-label for="num_interior" :value="__('Núm. Interior')" />
                                    <x-text-input id="num_interior" class="block mt-1 w-full" type="text" name="num_interior" :value="old('num_interior')" />
                                ...
                                <div class="md:col-span-3">
                                    ...
                                    <x-text-input id="domicilio_completo" class="block mt-1 w-full" type="text" name="domicilio_completo" :value="old('domicilio_completo')" placeholder="Ej: Calle 123, Col. Centro, CP 80000" />
                        ...
                        <div class="mt-8 border-t border-gray-200 dark:border-gray-700 pt-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                <div>
                                    ...
                                    <x-text-input id="fact_rfc" class="block mt-1 w-full" type="text" name="fact_rfc" :value="old('fact_rfc')" />
                                    <x-input-error :messages="$errors->get('fact_rfc')" class="mt-2" />
                                </div>
                                <div>
                                    <x-input-label for="fact_razon_social" :value="__('Razón Social')" />
                                    <x-text-input id="fact_razon_social" class="block mt-1 w-full" type="text" name="fact_razon_social" :value="old('fact_razon_social')" />
                                    <x-input-error :messages="$errors->get('fact_razon_social')" class="mt-2" />
                                </div>
                                <div>
                                    <x-input-label for="fact_correo" :value="__('Correo Facturación')" />
                                    <x-text-input id="fact_correo" class="block mt-1 w-full" type="email" name="fact_correo" :value="old('fact_correo')" />
                                ...
                                <div>
                                    ...
                                    <select id="fact_id_regimen_fiscal" name="fact_id_regimen_fiscal" class="block mt-1 w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:focus:ring-indigo-600 dark:focus:ring-offset-gray-800">
                                        ...
                                        @foreach ($regimenesFiscales as $regimen)
                                            <option value="{{ $regimen->id }}" {{ old('fact_id_regimen_fiscal') == $regimen->id ? 'selected' : '' }}>{{ $regimen->c_RegimenFiscal }} - {{ $regimen->Descripción }}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div>
                                    ...
                                    <x-text-input id="fact_cp_domicilio_fiscal" class="block mt-1 w-full" type="text" name="fact_cp_domicilio_fiscal" :value="old('fact_cp_domicilio_fiscal')" />
                                    <x-input-error :messages="$errors->get('fact_cp_domicilio_fiscal')" class="mt-2" />
                                </div>
                                <div class="md:col-span-3">
                                    <x-input-label for="fact_domicilio_fiscal" :value="__('Domicilio Fiscal')" />
                                    <x-text-input id="fact_domicilio_fiscal" class="block mt-1 w-full" type="text" name="fact_domicilio_fiscal" :value="old('fact_domicilio_fiscal')" placeholder="Ej: Calle 123, Col. Centro, CP 80000" />
                                    <x-input-error :messages="$errors->get('fact_domicilio_fiscal')" class="mt-2" />
                                </div>
                            </div>
                        </div>
