...
<head>
    <meta charset="utf-8">
    <title>Estado de Cuenta - {{ $predio->Clave_predial }}</title>
    <style>
        @page { margin: 20mm; }
        ...
        <table class="grid-2">
            ...
            <tbody>
                ...
                <tr style="font-size: 6.5pt;">
                    ...
                    <td>${{ $c['baldio'] ? number_format($c['baldio'], 2) : '0.00' }}</td>
                ...
                <tr class="total-row" style="font-size: 6.5pt;">
                    ...
                    <td><b>${{ number_format($c->sum(fn($r) => $r['baldio'] ? $r['baldio'] : 0), 2) }}</b></td>
                ...
                <tr>
                    <td colspan="13" style="padding-top: 8px;">
                        <b>Años pendientes de pago en predio:</b> {{ count($calculos) }} &nbsp;&nbsp;&nbsp;
                        <b>SubTotal Predio:</b> ${{ number_format($subtotal, 2) }} &nbsp;&nbsp;&nbsp;
                        <b>Descuentos:</b> ${{ number_format($descuentoTotal, 2) }} &nbsp;&nbsp;&nbsp;
                        <b>Total Predio:</b> ${{ number_format($totalPredio, 2) }}
                    </td>
                </tr>
                @endif
            </tbody>
